...
export default function TechProfileTabs({ company }: { company: Company }) {
  ...
  const tabs = [
    ...
    hasCerts ? { id: "certs", label: "Certifications & Security", locked: isFree } : null,
    hasFeatures ? { id: "features", label: "Features", locked: !isElite || isFree } : null,
    hasPricing ? { id: "pricing", label: "Pricing", locked: !isElite || isFree } : null,
